						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<img src="images/iconoMaestro.png" align="left" width="200px" height="200px">
							  ...
							  <!--<center><h2 class="cursive-font primary-color">
                        		<?php echo $uname = $_GET['profesor'];
								$user = $_GET['user'];?></h2></center>-->
							  <?php
								include("conexion.php");
							...
							?>
								...
								<a class="boton" href="Reseña.php?profesor=<?php echo $uname?>&user=<?php echo $user?>">EVALUAR</a>
						...
						<div class="">
							<a class="fh5co-card-item">
								...
								$result = $conexion->query("SELECT * FROM boton where username='$user' and id_reseña=$idR");
									...
									<form action = "Profesor2.php?profesor=<?php echo $idP ?>&user=<?php echo $user?>&idR=<?php echo $idR?>"   method="post">
										<button  type="submit" name="dislike"  class="" style="float: left; background-color: #D32F2F; border-color: #D32F2F ; color:white; font-size: 16px; width: 12%;">Dislike</button>
									</form>
								<?php
									}?>
							</a>
